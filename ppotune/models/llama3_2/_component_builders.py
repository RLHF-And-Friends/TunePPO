...
from torchtune.models.llama3_2._component_builders import (
    llama3_mlp,
...
def llama3_2_classifier(
    ...
    *,
    ...
    """
    Build the decoder associated with the Llama3.2 classification model.
    This includes:
    - Token embeddings
...
def lora_llama3_2_classifier(
    lora_attn_modules: List[LORA_ATTN_MODULES],
    apply_lora_to_mlp: bool = False,
    apply_lora_to_output: bool = False,
    *,
    # llama3.2 classifier args
    num_classes: int,
    # llama3.2 args
    vocab_size: int,
    num_layers: int,
    ...
    """
    Return a version of Llama3.2 classifier (an instance of 
    ...
    Returns:
        TransformerDecoder: Instantiation of Llama3.2 classification model 
        with LoRA applied to a subset of the attention projections in each 
        layer.
