...
SYSTEM_PROMPT = (
    ...
    "Put your reasoning in <think> tags and your final answer in "
    "<answer> tags. Your answer must be exactly \"entailment\" if the "
    "statement follows from the context, or \"not entailment\" if it does not."
)
