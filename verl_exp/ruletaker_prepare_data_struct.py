...
SYSTEM_PROMPT = (
    ...
    "<graph>a JSON array of every fact and rule application you used</graph>\n"
    "<answer>entailment OR not entailment</answer>\n\n"
    "Rules for the <graph> block:\n"
    "- It MUST be a valid JSON array.\n"
    "- Each element MUST be an object with exactly three string keys: "
    "\"src\", \"rel\", \"tgt\".\n"
    ...
    "<graph>[{\"src\": \"Alice\", \"rel\": \"is\", \"tgt\": \"kind\"}, "
    "{\"src\": \"kind people\", \"rel\": \"are\", \"tgt\": \"happy\"}, "
    "{\"src\": \"Alice\", \"rel\": \"is\", \"tgt\": \"happy\"}]</graph>\n"
...
USER_TEMPLATE = (
    ...
    "Reply with <think>...</think><graph>[...]</graph><answer>entailment OR "
    "not entailment</answer>."
)
