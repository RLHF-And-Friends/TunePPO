...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        reward_log_keys (Optional[list[str]]): If set, log these non_tensor_batch keys each step as
            reward/{{key}}/mean|std|max|min (wandb/console).
    ...
    # Keys in batch.non_tensor_batch (from compute_score dict) to log each step as reward/{key}/*.
